...
const GallerySection = () => {
    ...
    return (
        <section className={`gallery-section py-16 md:py-5  ${
            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-8 md:mb-12 max-w-7xl mx-auto px-2">
                    <div className={`text-center md:text-left mb-6 md:mb-0 transition-all duration-700 ${
                        sectionVisible ? 'animate-slide-in-left' : 'opacity-0'
                    }`}>
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 font-header mb-2">
                            Our Gallery
                        </h2>
                        <p className="text-gray-500 max-w-2xl text-base md:text-lg font-light">
                            Experience the relaxing atmosphere.
                        </p>
                    </div>
                ...
                <div className={`relative max-w-8xl mx-auto transition-all duration-700 ${
                    ...
                    <div ref={facilitiesRef} className="flex overflow-x-auto gap-6 pb-8 snap-x snap-mandatory scroll-smooth hide-scrollbar px-2" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                        {facilities.map((item, index) => (
                            <div 
                                key={index} 
                                className={`min-w-[250px] md:min-w-[320px] lg:min-w-[400px] flex-shrink-0 snap-center relative group transition-all duration-700 ${
                                    sectionVisible ? 'animate-fade-in' : 'opacity-0'
                                }`}
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 to-transparent p-4 md:p-6 pt-12">
                                    <h3 className="text-xl md:text-2xl font-bold text-white font-header tracking-wide">
                                        {item.title}
                                    </h3>
                                </div>
                            </div>
