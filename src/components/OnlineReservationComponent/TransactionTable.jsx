...
const TransactionTable = ({ searchQuery = '', viewMode = 'active', statusFilter = 'All' }) => {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    let result = transactions.filter(t => {
      // ONLINE FILTER
      if (t.booking_type !== 'Online') return false; 
    ...
    <>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              {filteredTransactions.length === 0 ? <tr><td colSpan="8" className="px-6 py-12 text-center text-gray-400 italic">No online transactions found.</td></tr> : filteredTransactions.map(t => {
      ...
      <div className="lg:hidden bg-white border border-gray-200 rounded-xl shadow-sm mt-4 overflow-hidden">
        ...
        <div className="divide-y divide-gray-100">
          {filteredTransactions.length === 0 ? <div className="px-6 py-12 text-center text-gray-400 italic">No online transactions found.</div> : filteredTransactions.map(t => (
